                ...
                <Box>
                    ...
                    <form>
                        <Field>
                            ...
                            <Input value={titulo} placeholder='Digite o titulo da noticia' id='titulo' name='titulo' type='text' hidden={false} onChange={(e)=>{onChangeTitulo(e)}} onEnter={()=>{}}/>
                        </Field>
                        <Field>
                            <label htmlFor="conteudo">Conteudo:</label>
                            <Input value={conteudo} placeholder='Digite o conteudo da noticia' id='conteudo' name='conteudo' type='text' hidden={false} onChange={(e)=>{onChangeConteudo(e)}} onEnter={()=>{}}/>
                        </Field>
                        <Field>
